export function DecisionOutcomes() {
  return (
    <g className="decision-outcomes">
      <g className="decision-outcome" transform="translate(650 112)">
        <circle r="34" />
      ...
      <g className="decision-outcome is-active" transform="translate(650 212)">
        <circle r="34" />
        <circle className="decision-outcome-inner" r="24" />
        <path d="M-12 0 H12" />
      </g>
      ...
      <g className="decision-outcome" transform="translate(650 312)">
        <circle r="34" />
        <circle className="decision-outcome-inner" r="24" />
