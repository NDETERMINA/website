...
These surfaces are reference workflows for generated coverage, corpus review,
...
<DataTable
  ...
  rows={[
    ...
    ["corpus index/import/reconcile/health/list/show/open", "Review local artifact corpora and generated coverage sidecars."],
