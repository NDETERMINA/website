...
<CTA title="Read the Results Packet" description="The run is only useful if the team can inspect the traces, findings, manifests, and compare output." href="/docs/results-packets" action="Results Packets" />
