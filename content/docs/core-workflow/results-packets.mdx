## What a Results Packet is

A Results Packet is the durable artifact set from a Behavior Trial, compare run, generated coverage workflow, or local artifact review. It should be safe to attach to a release ticket or pull request.
...
Docs should describe sensitive values as secret refs, digests, sizes, summaries, or artifact refs. Do not expect raw credentials or tokens in normal Results Packets.
</Callout>
